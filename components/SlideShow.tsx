  ...
  return (
    <div id='home' className='relative w-full overflow-hidden'>
      ...
      <div className='hidden md:block h-max overflow-hidden relative'>
        ...
        <div className='opacity-50 font-greatVibes absolute inset-x-0 bottom-0 flex flex-col space-y-4 items-center justify-center text-white text-5xl font-bold bg-black bg-opacity-50 py-3'>
          <h3>Kanika & Harsh</h3>
      ...
      <div className='block md:hidden h-full relative'>
        ...
        <div className='opacity-80 font-greatVibes absolute inset-x-0 bottom-0 flex flex-col space-y-3 items-center justify-center text-white text-3xl font-bold py-3'>
          <h3>Kanika & Harsh</h3>
          <h3 className='font-semibold'>#KAnHA</h3>
        </div>
      </div>
