  ...
  return (
    <div id='home' className='relative w-full overflow-hidden'>
      ...
      <div className='hidden md:block h-max overflow-hidden relative'>
        ...
        <div className='font-lovelight absolute inset-0 flex flex-col space-y-4 items-center justify-center text-white text-3xl md:text-5xl font-bold bg-black bg-opacity-50'>
          <h3>Kanika & Harsh</h3>
          <h3>#KAnHA</h3>
        </div>
      </div>
